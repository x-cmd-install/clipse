...
[![x-cmd/install — clipse Code Quality Monitoring Repo Card](https://repo.x-cmd.io/clipse.svg?lang=zh)](https://x-cmd.com/install/clipse)
...
- **Star**: 1,044 · **Fork**: 55 · **开放 issue**: 114 · **贡献者**: 22

## 累计统计

- **发布数**: 12 · **已合并 PR**: 179 · **开放 PR**: 18 · **已关闭 issue**: 86 · **开放 issue**: 28 · **提交数**: 364
...
_数据快照: `data/card/260920.yml` · 2026-09-20T05:14:51Z._
